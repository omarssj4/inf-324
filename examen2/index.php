  ...
  <div class="row">
     <section class="col-2">
        <nav class="nav flex-column navbar navbar-expand-lg bg-body-tertiary">
            <a href="index.php" id="mostrarFormulario" class="navbar-brand">Iniciar Sesion</a>
           <a class="navbar-brand" aria-current="page" href="#">Registrarse</a>
           <a class="navbar-brand" aria-current="page" href="#">About us</a>
       </nav>
   </section>
   <section class="col-10">
    <form action="login/valida.php?ci='1'" method="GET" id="miFormulario" class="mt-4" style="display:none;">
      <!-- Email input -->
    ...
    <div class="row mb-4">
        <div class="col d-flex justify-content-center">
          ...
          <div class="form-check">
            <input class="form-check-input" type="checkbox" name="ci" id="form2Example31" checked />
...
<script>
    $(document).ready(function(){
            // Al hacer clic en el enlace, mostramos el formulario
        $("#mostrarFormulario").click(function(event){
                event.preventDefault();  // Evita el comportamiento predeterminado del enlace
                $("#miFormulario").toggle();  // Alterna la visibilidad del formulario
            });
    });
</script>
<div class="container">
