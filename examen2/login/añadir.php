...
<div class="container mt-5">
    ...
    <form action="agregar.php" method="GET">
       ...
       <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text"  class="form-control" id="Macro_distrito" name="Macro_distrito" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="tipo_impuesto" name="tipo_impuesto">
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text"  class="form-control" name="valor_catastral">
            </div>
        </div>
        <div class="row mb-3">
            <label for="direccion" class="col-sm-2 col-form-label">Tipo de Propiedad</label>
            <div class="col-sm-10">
                <input type="text"  class="form-control" name="tipo_propiedad">
            </div>
        </div>
        <div class="row mb-3">
