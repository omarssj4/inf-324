...
zona='".$zona."', Macro_distrito='".$Macro_distrito."',
 tipo_impuesto='".$tipo_impuesto."',superficie='".$superficie."',valor_catastral='".$valor_catastral."',tipo_propiedad='".$tipo_propiedad."',tipo_propiedad='".$tipo_propiedad."',ci='".$ci."',fecha_registro='".$fecha."'where cod_catastro='".$catastro."'";
