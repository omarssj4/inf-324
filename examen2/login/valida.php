...
$sql="select nombre_usuario,apellido from funcionario where nombre_usuario='$nombre'and password='$pass' and rol=1";
...
if ($resultado->num_rows > 0) {
 ...
 $sql="select nombre_usuario,apellido from funcionario where nombre_usuario='$nombre'and password='$pass' and rol=0";
 $resultado= mysqli_query($con,$sql);
 if ($resultado->num_rows > 0) {
        // Si el usuario y la contraseña son correctos, almacenamos la sesión
