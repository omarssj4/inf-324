...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="../tramites/impuestos/index.php">Impuestos Municipales</a></li>
    ...
    <div class="row">
      <section class="col-2">
        <nav class="nav flex-column navbar navbar-expand-lg bg-body-tertiary">
          ...
          <a class="navbar-brand" aria-current="page" href="#"  id="showTable1">Listar Personas</a>
          <a class="navbar-brand" aria-current="page" href="#" id="showTable2" >Listar Catastros</a>
  ...
  while($fila=mysqli_fetch_array($resultado))
  {
    ...
    echo"<td>";
    echo"<a href='../persona/actualizarp.php?ci=".$fila["ci"]."' class='btn btn-success'>Actualizar</a>";
    echo"<a href='../persona/eliminarp.php?ci=".$fila["ci"]."' class='btn btn-danger'>Eliminar</a>";
    echo"</td>";
    echo"</tr>";
  }
?>
<tr><td><a href='../persona/anadirp.php' class='btn btn-primary'>Añadir</a></td></tr>
</table>
  ...
  ?>
  <div class="container-fluid">
  <table class="table table-striped" id="tabla2" style="display:none;">
  <tr>
  ...
  while($fila=mysqli_fetch_array($resultado))
  {
    ...
    echo"<td>";
    echo"<a href='actualizar.php?codigo=".$fila["cod_catastro"]."' class='btn btn-success'>Actualizar</a>";
    echo"<a href='eliminar.php?codigo=".$fila["cod_catastro"]."' class='btn btn-danger'>Eliminar</a>";
    echo"</td>";
    echo"</tr>";
  }
?>
<tr><td><a href='añadir.php' class='btn btn-primary'>Añadir</a></td></tr>
</table>
</div>
<script>
